...
![](octopus.png){fig-alt="An octopus character juggling bioinformatics tool icons in each of its arms."}
...
![](one-ring.png){fig-alt="A crown atop a small stacked castle of building blocks."}
...
![](terminal-wrench.png){fig-alt="A terminal-window character fixing a cable connection with a wrench."}
