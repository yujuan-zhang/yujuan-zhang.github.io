...
![](octopus.png){.illustration fig-alt="An octopus character juggling bioinformatics tool icons in each of its arms."}
...
![](one-ring.png){.illustration fig-alt="A crown atop a small stacked castle of building blocks."}
...
![](dag-figure.png){fig-alt="A task-dependency graph: two parallel chains, bwa_map to samtools_sort to samtools_index, for sample A and sample B."}

## Back to Basics

![](terminal-wrench.png){.illustration fig-alt="A terminal-window character fixing a cable connection with a wrench."}
